...
We can  use [Aurelia Bundler](https://github.com/aurelia/bundler) to create a gulp task for bundling our JSPM app. Let's jump right into it. We will use the `skeleton-navigation` as our app to bundle. If you don't have that set up. Follow [these steps](https://github.com/aurelia/skeleton-navigation#running-the-app).
...
```JavaScript Typical Bundle Configuration
"dist/app-build": {
  includes: [
    '[*.js]',
    '*.html!text',
...
```JavaScript Full HTML Import Bundle Config
var gulp = require('gulp');
var bundle = require('aurelia-bundler').bundle;
...
```JavaScript HTML Import Injection Options
indexFile: 'index.html',
destFile : 'dest_index.html'
```
