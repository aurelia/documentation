...
The `aurelia-middleware-koa` library is a middleware for [Koa](https://koajs.com/) which instructs the `aurelia-ssr-engine` to render the requested page and returns the fully rendered HTML.
